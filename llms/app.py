...
# }"""
    ...
    while (attempt_counter<5) and (returncode!=0):
        ...
        answer +="""   function validateHookAddress(CLBaseHook _this) internal pure {
            }
        }"""
        ...
        if (returncode)!=0:
            ...
            with open(f"../foundry_hook_playground/foundry-out/{file_name}/{contract_name}.json", 'r') as file:
            ...
            print(f'{deployer_address}, {required_flags},{bytecode}')
            ...
            return jsonify(solidity_code=answer, bytecode=bytecode, abi=contract_json["abi"], n_constructor=last_n_arguments_in_constructor)
        time.sleep(3)
        attempt_counter+=1
