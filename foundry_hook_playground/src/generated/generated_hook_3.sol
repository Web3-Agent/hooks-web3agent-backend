...
contract HighestLiquidityHolderHook is CLBaseHook {
    ...
    function beforeAddLiquidity(
        ...
        uint256 liquidityDelta = params.liquidityDelta >= 0 ? uint256(params.liquidityDelta) : 0;

        uint256 newLiquidity = highestLiquidityHolder[poolId].liquidity + liquidityDelta;
    ...
    function afterRemoveLiquidity(
        ...
        if (sender == highestLiquidityHolder[poolId].holder) {
            uint256 remainingLiquidity = highestLiquidityHolder[poolId].liquidity > liquidityDelta
                ? highestLiquidityHolder[poolId].liquidity - liquidityDelta
                : 0;
                
            if (remainingLiquidity == 0 || liquidityDelta == 0) {
                ...
                highestLiquidityHolder[poolId].liquidity = remainingLiquidity;
            }
        }
